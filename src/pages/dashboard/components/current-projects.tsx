...
export const Button = ({
  ...
  <button
    className="btn bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90 mr-4 my-2"
    onClick={action}
  >
    {label}
  </button>
...
const CurrentProjects = () => {
  return (
    <div
      className="rounded-sm shadow-md bg-white py-2 lg:w-2/4 my-2 lg:my-0"
    >
