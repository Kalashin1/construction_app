    ...
    <div className="flex flex-col-reverse py-5 sm:flex-row sm:justify-between">
      <div className="mt-2 flex items-center justify-between space-x-1">
        <div className="flex items-center px-2.5">
          <label className="flex h-8 w-8 items-center justify-center" data-tooltip="Select All">
          ...
          <div id="top-header-menu" className="inline-flex">
            <button className="popper-ref btn -ml-1 h-5 w-5 rounded p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              <i className="fas fa-chevron-down text-tiny+"></i>
            </button>
